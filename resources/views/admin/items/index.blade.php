...
<div class="items-page">
  <section class="items-hero">
    <div class="items-hero__inner">
      ...
      <div class="items-hero__actions">
        <a class="items-add-btn" href="{{ route('admin.items.create') }}">+ Tambah Barang</a>
      </div>
    </div>
  </section>
  ...
  <section class="items-summary">
    <div class="items-summary__card">
      ...
      <p class="items-summary__value">{{ $items->count() }}</p>
  ...
  @if(session('success'))
    <div class="items-alert">{{ session('success') }}</div>
  @endif
  ...
  <section class="items-table-shell">
    <div class="items-table-head">
      ...
      <div class="items-table-count">{{ $items->count() }} Data</div>
    </div>
        ...
        <tbody>
          @forelse($items as $it)
            <tr>
              ...
              <td class="items-category">{{ $it->category?->nama_kategori ?? '-' }}</td>
              ...
              <td>
                <span class="items-stock">{{ $it->stok }}</span>
              </td>

              <td class="items-date">{{ $it->tanggal }}</td>
