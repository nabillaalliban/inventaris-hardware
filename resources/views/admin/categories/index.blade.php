...
<div class="category-page">
  <section class="category-hero">
    <div class="category-hero__inner">
      ...
      <div class="category-hero__actions">
        <a href="{{ route('admin.categories.create') }}" class="category-add-btn">+ Tambah Kategori</a>
      </div>
    </div>
  </section>
  ...
  <section class="category-summary">
    <div class="category-summary__card">
      ...
      <p class="category-summary__value">{{ $categories->count() }}</p>
  ...
  @if(session('success'))
    <div class="category-alert">{{ session('success') }}</div>
  @endif
  ...
  <section class="category-table-shell">
    <div class="category-table-head">
      ...
      <div class="category-table-count">{{ $categories->count() }} Kategori</div>
    </div>
    ...
    <div class="table-wrap">
      <table class="table">
        ...
        <tr>
          <td>
            <span class="category-index">{{ $loop->iteration }}</span>
          </td>
          <td>
