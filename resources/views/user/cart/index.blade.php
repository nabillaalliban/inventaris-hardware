...
<div class="cart-wrap">
  <div class="drawer">
    ...
    <div class="drawer-foot">
      <a class="btnx" href="{{ route('user.items.index') }}">Lanjut pilih barang</a>

      @if($cart->items->count())
        <form action="{{ route('user.cart.checkout') }}" method="POST" style="flex:1; display:flex; flex-direction:column; gap:8px;">
  @csrf
