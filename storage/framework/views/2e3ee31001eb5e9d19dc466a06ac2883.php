...
<div class="user-loans-page">
  <section class="user-loans-hero">
    <div class="user-loans-hero__inner">
      ...
      <div class="user-loans-hero__actions">
        <a class="user-loans-stat-btn" href="<?php echo e(route('user.loans.stats')); ?>">📊 Statistik</a>
      </div>
    </div>
  </section>
  ...
  <section class="user-loans-summary">
    <div class="user-loans-summary__card">
      ...
      <p class="user-loans-summary__value"><?php echo e($loans->count()); ?></p>
  ...
  <?php if(session('success')): ?>
    <div class="user-loans-alert"><?php echo e(session('success')); ?></div>
  <?php endif; ?>
  ...
  <section class="user-loans-table-shell">
    <div class="user-loans-table-head">
      ...
      <div class="user-loans-table-count"><?php echo e($loans->count()); ?> Data</div>
    </div>
    ...
    <div class="table-wrap">
      <table class="table">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $loans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <tr>
            <td><span class="user-loans-index"><?php echo e($loop->iteration); ?></span></td>
            <td>
            ...
            <td class="user-loans-type"><?php echo e(strtoupper($l->tipe_peminjam)); ?></td>
            <td class="user-loans-date"><?php echo e($l->tanggal_pinjam); ?></td>
            <td class="user-loans-date"><?php echo e($l->due_date ?? '-'); ?></td>
            <td><span class="user-loans-status <?php echo e($l->status); ?>"><?php echo e($l->status); ?></span></td>
              ...
              <div class="user-loans-items">
                <?php $__currentLoopData = $l->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="user-loans-item-row">
                    ...
                    <span class="user-loans-qty">x<?php echo e($it->qty); ?></span>
                  </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\inventaris-hardware\resources\views/user/loans/index.blade.php ENDPATH**/ ?>