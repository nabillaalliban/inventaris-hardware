...
<style>
  .cart-wrap{ display:flex; justify-content:flex-start; }
  .drawer{
    width: 100%;
    max-width: 800px;
    background:#fff;
...
<div class="cart-wrap">
  <div class="drawer">
      ...
      <?php $__empty_1 = true; $__currentLoopData = $cart->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="cart-item">
          ...
          <div class="ci-actions">
            <form action="<?php echo e(route('user.cart.update',$row->id)); ?>" method="POST" style="display:flex;gap:8px;align-items:center;">
            ...
            <form action="<?php echo e(route('user.cart.remove',$row->id)); ?>" method="POST" onsubmit="return confirm('Hapus item?')">
    ...
    <div class="drawer-foot">
      <a class="btnx" href="<?php echo e(route('user.items.index')); ?>">Lanjut pilih barang</a>

      <?php if($cart->items->count()): ?>
        <form action="<?php echo e(route('user.cart.checkout')); ?>" method="POST" style="flex:1; display:flex; flex-direction:column; gap:8px;">
  <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /opt/lampp/htdocs/inventaris-hardware/resources/views/user/cart/index.blade.php ENDPATH**/ ?>