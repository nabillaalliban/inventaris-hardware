...
<div class="form-wrap">
  ...
  <div class="form-shell">
    ...
    <div class="form-top">
      ...
      <a href="<?php echo e(route('admin.inventaris.index')); ?>" class="btn-secondary">← Kembali</a>
    </div>
    ...
    <div class="form-body">
      ...
      <form action="<?php echo e(route('admin.inventaris.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        ...
        <div class="form-actions">
          <a href="<?php echo e(route('admin.inventaris.index')); ?>" class="btn-secondary">Batal</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /opt/lampp/htdocs/inventaris-hardware/resources/views/admin/inventaris/create.blade.php ENDPATH**/ ?>