...
<div class="inbound-page">
  <section class="inbound-hero">
    <div class="inbound-hero__inner">
      ...
      <div class="inbound-hero__actions">
        <a class="inbound-add-btn" href="<?php echo e(route('admin.inbounds.create')); ?>">+ Tambah Barang Masuk</a>
      </div>
    </div>
  </section>
  ...
  <section class="inbound-summary">
    <div class="inbound-summary__card">
      ...
      <p class="inbound-summary__value"><?php echo e($logs->count()); ?></p>
  ...
  <?php if(session('success')): ?>
    <div class="inbound-alert"><?php echo e(session('success')); ?></div>
  <?php endif; ?>
  ...
  <section class="inbound-table-shell">
    <div class="inbound-table-head">
      ...
      <div class="inbound-table-count"><?php echo e($logs->count()); ?> Data</div>
    </div>
    ...
    <div class="table-wrap">
      <table class="table">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <tr>
            <td>
              <span class="inbound-index"><?php echo e($loop->iteration); ?></span>
            </td>
            <td>
              <div class="inbound-item">
                <strong><?php echo e($l->item?->nama_barang ?? '-'); ?></strong>
                <span>Data barang inventaris</span>
              </div>
            </td>
            <td>
              <span class="inbound-qty"><?php echo e($l->qty_masuk); ?></span>
            </td>
            <td class="inbound-date"><?php echo e($l->tanggal_masuk); ?></td>
            <td class="inbound-note"><?php echo e($l->keterangan ?? '-'); ?></td>
          </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\inventaris-hardware\resources\views/admin/inbounds/index.blade.php ENDPATH**/ ?>