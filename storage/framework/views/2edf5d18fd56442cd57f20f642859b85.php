    ...
    <div class="dashboard-showcase__inner">
      <div>
        ...
        <div class="dashboard-showcase__meta">
          <div class="dashboard-showcase__meta-card">
            ...
            <p class="dashboard-showcase__meta-value"><?php echo e($jumlahKategori); ?></p>
          </div>
          <div class="dashboard-showcase__meta-card">
            <p class="dashboard-showcase__meta-label">Total Barang</p>
            <p class="dashboard-showcase__meta-value"><?php echo e($jumlahBarang); ?></p>
          </div>
        </div>
      </div>
      ...
      <div class="dashboard-showcase__panel">
        <div>
          ...
          <p class="dashboard-showcase__panel-number"><?php echo e($jumlahBarang); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\inventaris-hardware\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>