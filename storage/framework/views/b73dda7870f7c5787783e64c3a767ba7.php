  ...
  <section class="user-items-hero">
    <div class="user-items-hero__inner">
      ...
      <div class="user-items-count">
        ...
        <p class="user-items-count__value"><?php echo e($items->count()); ?></p>
      </div>
    </div>
  </section>

  <?php if(session('success')): ?>
    <div class="user-items-alert"><?php echo e(session('success')); ?></div>
  <?php endif; ?>

  <form action="<?php echo e(route('user.items.index')); ?>" method="GET" class="user-items-search">
    <input
      type="text"
      name="search"
    ...
    <?php if(request('search')): ?>
      <a href="<?php echo e(route('user.items.index')); ?>" class="user-items-search__reset">Reset</a>
    <?php endif; ?>
  </form>
    ...
    <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
      <div class="catalog-card">
        <div class="catalog-image">
          <img src="<?php echo e(asset('storage/' . $it->foto)); ?>" alt="<?php echo e($it->nama_barang); ?>">
        </div>
        ...
        <div class="catalog-body">
          ...
          <span class="user-item-stock">Stok: <?php echo e($it->stok); ?></span>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\inventaris-hardware\resources\views/user/items/index.blade.php ENDPATH**/ ?>